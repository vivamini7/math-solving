...
def Judge_condition(question,condition):
    ...
    T_or_F = generate_from_judge(messages, max_tokens = 4, model="gpt-4o-mini-2024-07-18", temperature=0.7, n=1)
    return T_or_F
...
def Judge_statement(Known_condtions,condition_from_thinker):
    ...
    messages.append(message)
    T_or_F = generate_from_judge(messages, max_tokens = 16, model="gpt-4o-mini-2024-07-18", temperature=0.7, n=1)
    return T_or_F
