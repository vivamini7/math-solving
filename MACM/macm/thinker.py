...
def Analysis_conditions(question):
    ...
    # answer = generate_from_GPT(messages, max_tokens = 256, model="gpt-4o-mini-2024-07-18", temperature=0.7, n=1)[0]["message"]["content"]
...
def Think_thoughts(conditions,objectives):
    ...
    messages.append(message)
    # new_condition = generate_from_GPT(messages, max_tokens = 128, model="gpt-4o-mini-2024-07-18", temperature=0.7, n=1)[0]["message"]["content"]
...
def Think_Steps(condition_from_thinker,objective_from_thinker):
    ...
    messages.append(message)
    # steps = generate_from_GPT(messages, max_tokens = 256, model="gpt-4o-mini-2024-07-18", temperature=0.7, n=1)[0]["message"]["content"]
